##
#        File: moviefeedwebserviceconfig.py
#     Created: 11/10/2020
#     Updated: 11/15/2020
#  Programmer: Cuates
#  Updated By: Cuates
#     Purpose: Movie feed web service configuration
##
...
# Class
class MovieFeedWebServiceConfig:
