        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Initailize list
              possibleParams = ['titlelong', 'titleshort', 'titleshortold', 'publishdate', 'actionstatus']
              removeParams = ['titlelong', 'titleshortold', 'publishdate']

              # Update movie feed
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MariaDBSQLMovie', 'updating', 'insertupdatedeletemediafeed', 'updateMovieFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('PGSQLMovie', 'updating', 'insertupdatedeletemediafeed', 'updateMovieFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MSSQLLMovie', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateMovieFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MSSQLWMovie', 'updating', 'dbo.insertupdatedeleteMediaFeed', 'updateMovieFeedTitleShortActionStatus', possibleParams, payloadResponse['Result'], removeParams)
        ...
        if webserviceHeaderResponse['Status'] == 'Success':
          ...
          if payloadResponse.get('Status') != None:
            ...
            if payloadResponse['Status'] == 'Success':
              ...
              # Delete movie feed
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MariaDBSQLMovie', 'deleting', 'insertupdatedeletemediafeed', 'updateMovieFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('PGSQLMovie', 'deleting', 'insertupdatedeletemediafeed', 'updateMovieFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MSSQLLMovie', 'deleting', 'dbo.insertupdatedeleteMediaFeed', 'updateMovieFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
              resultDict = mfwsclass._insertupdatedeleteMovieFeed('MSSQLWMovie', 'deleting', 'dbo.insertupdatedeleteMediaFeed', 'updateMovieFeedTitleShort', possibleParams, payloadResponse['Result'], removeParams)
